...
def start_training(start_epoch, end_epoch, domain_size, batch_size, unet, myoptimizer, warmStart=True, dtype=torch.cuda.FloatTensor):
    # # Start training
    ...
    if warmStart:
        ...
        v0 = 0.2
        u_s, v_s, p_s = solve_flow(early_time_steps, domain_size, domain_size, u, v, dt, dx, dy, p, u0 = u0_vector, v0 = v0)
        S_sample, s_solution = get_samples(domain_size, u0=u0_vector, v0=v0, warm_start=warmStart, u_h = u_s, v_h = v_s, p_h = p_s)
    else:
...
if __name__ == '__main__':
    ...
    if opt.cuda and torch.cuda.is_available():
        ...
        dtype = torch.FloatTensor
    filename = "1211_warm/history_1000.pth"
